package com.sjz.demo.controller;
...
import com.sjz.demo.vo.SocketMsg;
...
public class MyWebSocket {
    ...
    public void onOpen(Session session,@PathParam("nickname") String nickname) {
        ...
        this.session.getAsyncRemote().sendText(nickname+"成功连接上WebSocket(其频道号："+session.getId()+")-->当前在线人数为："+webSocketSet.size());
    }
    /**
     * 连接关闭调用的方法
     */
